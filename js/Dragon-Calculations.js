...
var Set_Dragon_Values = function(){

	set_dragon_lvl();
	calculate_dragon_cost();
	calculate_dragon_training_time();
}

var calculate_dragon_training_time = function(){

	////dragon training time per in seconds
	var time_per = 1800;
	////number of dragon user has inputed 
	var $quantity = $('#Dragon_quantity').val();
	
	///////////
	//calculate the secs
	var seconds = '00';
	////dragon training time total secs equals training time per multiplied by amount user inputs
	var total_secs = time_per * $quantity;
	//if dragon training time in total secs - total secs rounded down does not equal zero AND is not lower than 0
	...
	var hours = '00';
	////dragon training time in total seconds for hours variable
	...
	var minutes = '00';
	////dragon training time in total seconds for minutes variable
	...
	$('#Dragon_trainingTime').text(hours + ':' + minutes + ':' + seconds);
}
...
var calculate_dragon_cost = function(){
	/////dragon_amount
	var $amount = $('#Dragon_quantity').val();
	/////dragon_level
	var $level = $('#Dragon_level').val();
	////dragons elixer cost display element
	var $elixir_cost = $('#Dragon_elixirCost');
	////dragon cost per unit
	var cost_per;
	////dragons cost total which is the amount multiplied by cost per unit
	var cost_total;
...
var set_dragon_lvl = function(){
	////dragon_lvl
	var $lvl = $('#Dragon_level').val();
	////dragons image element
	var $image = $('#Dragon_image');

	if( $lvl == "1" ){
		$image.attr('src', 'img/dragon1.png');
	}
	else if( $lvl == "2" ) {
		$image.attr('src', 'img/dragon2.png');
	}
	else if( $lvl == "3" ) {
		$image.attr('src', 'img/dragon3.png');
	}
	else if( $lvl == "4" ) {
		$image.attr('src', 'img/dragon4.png');
	}
}

function dragonHandleChange(input) {
